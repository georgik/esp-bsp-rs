...
#[macro_export]
macro_rules! custom_lcd_display_interface {
...
#[macro_export]
macro_rules! custom_lcd_display {
...
#[macro_export]
macro_rules! custom_lcd_backlight {
    ($peripherals:ident, $config:expr) => {{
